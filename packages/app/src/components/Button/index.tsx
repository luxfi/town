...
const OUTLINED = {
  ...
  indigo:
    'bg-indigo-600 bg-opacity-25 outline-indigo-600 rounded text-indigo-gray-300 hover:bg-opacity-50 disabled:bg-opacity-20',
  pink: 'bg-pink bg-opacity-20 outline-pink rounded text-pink hover:bg-opacity-40 disabled:bg-opacity-20',
  gray: 'bg-dark-900 bg-opacity-50 outline-gray rounded text-gray hover:bg-opacity-100 disabled:bg-opacity-20',
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'indigo'
