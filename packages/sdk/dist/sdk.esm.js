...
var CURRENCY_SYMBOL_LOGO = (_CURRENCY_SYMBOL_LOGO = {}, _CURRENCY_SYMBOL_LOGO[CurrencySymbol.DAI] = DaiLogo, _CURRENCY_SYMBOL_LOGO[CurrencySymbol.ETH] = EthLogo, _CURRENCY_SYMBOL_LOGO[CurrencySymbol.WETH] = WethLogo, _CURRENCY_SYMBOL_LOGO[CurrencySymbol.USDC] = UsdcLogo, _CURRENCY_SYMBOL_LOGO[CurrencySymbol.USDT] = UsdtLogo, _CURRENCY_SYMBOL_LOGO);
...
var getCurrencyMap = function getCurrencyMap(contracts) {
  ...
  return _ref = {}, _ref[ChainId.MAINNET] = (_ChainId$MAINNET = {}, _ChainId$MAINNET[ZERO_ADDRESS] = Ether.onChain(ChainId.MAINNET), _ChainId$MAINNET[MAINNET_USDC] = new Token(ChainId.MAINNET, MAINNET_USDC, 6, 'USDC', 'USDC'), _ChainId$MAINNET[MAINNET_USDT] = new Token(ChainId.MAINNET, MAINNET_USDT, 6, 'USDT', 'USDT'), _ChainId$MAINNET[MAINNET_WETH] = new Token(ChainId.MAINNET, MAINNET_WETH, 18, 'WETH', 'WETH'), _ChainId$MAINNET), _ref[ChainId.ROPSTEN] = (_ChainId$ROPSTEN = {}, _ChainId$ROPSTEN[ZERO_ADDRESS] = Ether.onChain(ChainId.ROPSTEN), _ChainId$ROPSTEN[ROPSTEN_USDC] = new Token(ChainId.ROPSTEN, ROPSTEN_USDC, 6, 'USDC', 'USDC'), _ChainId$ROPSTEN[ROPSTEN_USDT] = new Token(ChainId.ROPSTEN, ROPSTEN_USDT, 6, 'USDT', 'USDT'), _ChainId$ROPSTEN[ROPSTEN_WETH] = new Token(ChainId.ROPSTEN, ROPSTEN_WETH, 18, 'WETH', 'WETH'), _ChainId$ROPSTEN), _ref[ChainId.HARDHAT] = (_ChainId$HARDHAT = {}, _ChainId$HARDHAT[ZERO_ADDRESS] = Ether.onChain(ChainId.HARDHAT), _ChainId$HARDHAT[HARDHAT_USDC] = new Token(ChainId.HARDHAT, HARDHAT_USDC, 6, 'USDC', 'USDC'), _ChainId$HARDHAT[HARDHAT_USDT] = new Token(ChainId.HARDHAT, HARDHAT_USDT, 6, 'USDT', 'USDT'), _ChainId$HARDHAT[HARDHAT_WETH] = new Token(ChainId.HARDHAT, HARDHAT_WETH, 18, 'WETH', 'WETH'), _ChainId$HARDHAT), _ref;
};
var getSymbolCurrencyMap = function getSymbolCurrencyMap(contracts) {
  ...
  return _ref2 = {}, _ref2[ChainId.MAINNET] = {
