...
const testPools = [testPool1, testPool2, testPool3, testPool4, testPool5];
...
const r5 = new MultiRouterHybrid(testPool5);

const r = new MultiRouterParallel([r1, r2, r3, r4, r5], gasPrice);
